...
\begin{tikzpicture}
    ...
    \node[empty] (fig1) at ($(SD1ll)!0.5!(SD1tr)+(0.015*\lx, 0.05*\ly)$)
	 {\includegraphics[width=0.27\textwidth]{subfigures/vel.pdf}};
    \node[empty] (fig2) at ($(SD2ll)!0.5!(SD2tr)+(0, 0.05*\ly)$)
	 {\includegraphics[width=0.27\textwidth]{subfigures/surface.pdf}};
    \node[empty] (fig3) at ($(SD3ll)!0.5!(Dtr)+(0, 0.05*\ly)$)
	 {\includegraphics[width=0.27\textwidth]{subfigures/frictionC.pdf}};
    % Equations
    \small
